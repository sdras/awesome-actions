...
- [MCP Lens Schema Audit](https://github.com/labmimors/dsh-mcp-lens) - Measure model-facing MCP tool-schema bytes and enforce tool-count or schema-byte CI budgets.
