...
- [VulnHawk](https://github.com/momenbasel/vulnhawk) - AI-powered code security scanner that detects missing authorization checks, insecure direct object references (IDOR), and business logic bugs.
