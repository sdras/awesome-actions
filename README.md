...
- [Run and step-debug GitHub Actions workflows locally](https://github.com/castorhrio/rehearsal) - Local runner with an interactive debugger: single-step jobs, re-run failed steps with container state preserved, inspect env, shell in.
