...
- [UIZZE UI Slop Gate](https://github.com/uizze/uizze) - Free GitHub Action that catches generic UI patterns, missing states, inert controls, and token drift in frontend changes before they ship.
