...
- [AI Agent Cost Leak Check](https://github.com/sravan27/context-os) - Scan repos for coding-agent context bloat before Claude Code, Codex, or Cursor waste tokens.
