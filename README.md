...
- [Hybrid RAG Issue & PR Assistant](https://github.com/Cagrik34/hybrid-rag-action) - Zero-cloud hybrid search engine combining SQLite FTS5 (BM25) and dense vectors for automated code triage and AST-grounded citations.
