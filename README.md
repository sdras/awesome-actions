...
- [Delimit API Governance](https://github.com/delimit-ai/delimit-action) - Detects 27 types of breaking API changes on every PR. Posts severity-graded comments with migration guides.
