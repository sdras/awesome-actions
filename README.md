...
- [Sentinel Secret Scanner](https://github.com/marketplace/actions/sentinel-git-secrets-scanner) - Ultra-lightweight Git secrets scanner to detect leaked API keys and prevent credential leaks.
