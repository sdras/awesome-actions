...
- [Code Rot Hotspots](https://github.com/zubairriaz/hotspot-tool) - Finds files that are both complex and frequently changed, and flags them on the PR that touches them.
