...
* [Dark-Moon](https://github.com/ASCIT31/Dark-Moon) - Run an autonomous AI penetration test (web/API/AD/Kubernetes) from your workflow after each build and export structured CVSS/CVE/MITRE findings.
