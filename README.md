...
- [ProofCore Release Notary](https://github.com/marketplace/actions/proofcore-release-notary) - Cryptographically notarize GitHub Releases and binary checksums on-chain using GitHub OIDC and Merkle tree batching.
