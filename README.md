...
- [Terraform Risk Accessor](https://github.com/Liam-Johnston/terraform-risk-accessor) - Analyze Terraform plan changes with AI and comment risk assessments on pull requests.
