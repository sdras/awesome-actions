...
- [Block PRs when their token-cost footprint regresses — a context/LLM token-cost gate for AI-agent and prompt files, comments the per-file attribution on the PR](https://github.com/wartzar-bee/ci-guardrail)
