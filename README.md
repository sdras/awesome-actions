...
- [Public-Path Evidence Check](https://github.com/Allura-Gensin/public-path-evidence-audit-starter) - Create a bounded Markdown report for one to five public HTTPS routes.
