...
- [DriftaBot Agent](https://github.com/DriftaBot/agent) - Detect breaking API changes in provider PRs and automatically open GitHub Issues in affected consumer repos.
