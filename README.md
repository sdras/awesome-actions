...
- [otel-budget-check](https://github.com/northstarappstudio-ops/otel-budget-check) - Fails PRs that exceed your OpenTelemetry telemetry budget; catches cost and cardinality regressions before merge.
