...
- [AET Evidence](https://github.com/AdvancingTitans/aet-evidence-action) - Runs read-only checks for agent instructions, skills, verification contracts, and dangerous authority.
