...
- [Hybrid RAG Issue & PR Assistant](https://github.com/Cagrik34/Hybrid-RAG-Issue-PR-Assistant) - Zero-cloud hybrid search engine combining SQLite FTS5 (BM25) and dense vectors for automated code triage and AST-grounded citations.
