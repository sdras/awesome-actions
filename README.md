...
- [OSS Maintenance Evidence Log](https://github.com/dusan-maintains/oss-maintenance-log) - Automated public evidence log for OSS maintenance. Tracks PR SLA, npm health, and repo metrics across abandoned packages. Self-updates every 6h.
