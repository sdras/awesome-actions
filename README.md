...
- [DepIntel — Dependency Intelligence](https://github.com/lunacompsia-oss/depintel-action) - Analyze PR dependency changes for vulnerabilities, license risks, and breaking changes.
