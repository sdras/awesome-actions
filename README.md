...
- [Agent Hook Scan](https://github.com/bphansg/agent-hook-scan) - Lints AI agent configs (Cursor/Claude/MCP) and flags risky workflow patterns like `curl | sh` and unpinned actions.
