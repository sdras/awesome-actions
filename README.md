...
- [App Store Review Monitor](https://github.com/hakaru/appstore-review-monitor) - Monitor App Store Connect review status and create GitHub Issues on changes with optional Slack, Discord, and Teams notifications.
