...
- [Go Exec Format Doctor](https://github.com/soul-sol/go-exec-format-doctor) - Fail a build when a Go binary's architecture does not match the target, without running it.
