...
- [PQC Tools](https://github.com/quantakrypto/pqc-tools) - Scans code and dependencies for quantum-vulnerable cryptography (RSA/ECDSA/ECDH) and comments a post-quantum migration plan on the PR.
