...
- [Macless Signing Doctor](https://github.com/jackson26-source/macless-signing-doctor) - Decodes an iOS provisioning profile/certificate or Android keystore and explains signing failures in plain English.
