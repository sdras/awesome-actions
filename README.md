...
- [Network Policy Enforcer](https://github.com/pwnchief/network-policy-enforcer) - Monitor and enforce outbound network policies on CI/CD runners using eBPF and iptables.
