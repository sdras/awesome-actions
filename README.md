...
- [SnapShot API Action](https://github.com/bakasa/snapshot-action) - Capture website screenshots in your CI/CD pipeline with custom viewports, full-page capture, PNG/JPEG, and auto-upload as workflow artifact.
