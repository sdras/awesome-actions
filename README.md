...
- [gh-actions-watchdog](https://github.com/Toninobandolero/gh-actions-watchdog) - Classifies failed workflow runs as GitHub-infra vs. code failures and auto-retries only the infra ones with backoff.
