...
- [pompelmi](https://github.com/pompelmi/pompelmi) - Zero-dependency ClamAV virus scanner. Bundles ClamAV inside Docker, updates signatures automatically, posts job summary with results.
