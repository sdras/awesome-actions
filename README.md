...
- [FTP Hash Deploy Action](https://github.com/Agundur-KDE/ftp-hash-deploy-action) - Deploys only changed files via server-side Git blob hashes, no state file needed.
