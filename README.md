...
- [aidemo — Record a Product Demo Video](https://github.com/tandryukha/aidemo) - Renders a narrated, captioned product-demo MP4 from a storyboard.json via deterministic browser replay, so a README/CI demo re-renders itself on every change with no API key.
