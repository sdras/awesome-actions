...
- [Hybrid RAG Issue & PR Assistant](https://github.com/Cagrik34/hybrid-rag-action) - Context-grounded repository triage with BM25 and dense semantic retrieval fusion.
