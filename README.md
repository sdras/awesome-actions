...
- [AI-Powered Release Notes Generator](https://github.com/fraygeist/changenote-ai) - Reads git history and generates human-quality release notes using AI. Supports 4 formats (standard, keep-a-changelog, semantic, narrative). Works as CLI or GitHub Action.
